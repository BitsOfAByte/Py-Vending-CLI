...
""")
        ...
        password = hasher.hash_sha3_512(str(passinput.getpass("Enter your password > ")))
...
""")
    ...
    while not registered:
        ...
        password = hasher.hash_sha3_512(passinput.getpass("Enter a unique password > "))
        if validator.validate_username(username) == True:
            registered = True
            db.create_user(username, password)
            print(f"Success! Account created, welcome {username}.")
        else:
